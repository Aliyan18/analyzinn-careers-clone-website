...
return (
<>
<div className="container" style={{backgroundColor: "#45526e",width:'100vw',marginBottom:0, marginLeft:0,marginRight:0,width:'100vw'}}>
  <footer
          className="text-center text-lg-start text-white"
          style={{backgroundColor: "#45526e",width:'98.5vw',left:0}}
          >
