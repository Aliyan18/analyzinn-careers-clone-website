  ...
  return (
    <div className="background">
        <div className="nextcontainer">
            ...
            <div className="text2">We support leaders to EVOLVE their organizations using our proven Digital marketing analyzinn services — <br></br> helping you achieve a competitive advantage with actionable insights.</div>
